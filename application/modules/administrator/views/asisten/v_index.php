...
<div class="card">
    ...
    <div class="card-body">
        <div class="text-left">
            <a href="<?php echo base_url('administrator/asisten/add') ?>" class="btn btn-sm btn-info"><i
                    class="icon-pen-plus mr-1"></i> Tambah Asisten</a>
        </div>
                    ...
                    if (result) {
                        $.ajax({
                            ...
                            error: function() {
                                $('#load_dt').unblock();
                                bx_alert(
                                    'gagal menghubungkan ke server cobalah mengulang halaman ini kembali'
                                    );
                            },
                            beforeSend: function() {
                                load_dt('#load_dt');
