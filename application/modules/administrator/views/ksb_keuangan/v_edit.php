...
<div class="card">
	<div class="card-header bg-white header-elements-inline py-2">
		<h5 class="card-title">Edit Kasubag Keuangan</h5>
	...
	<div class="card-body">
		...
		<?php echo form_open('administrator/ksb-keuangan/AjaxSave','class="form-horizontal" id="formAjax"'); ?>
		<div class="col-lg-12">
	...
	$('.advanced2AutoComplete').autoComplete({
		...
		events: {
			search: function (qry, callback) {
				...
				var user = $('#user').val();
				$.ajax(
					uri_dasar+'administrator/ksb-keuangan/AjaxGet',
					{
	...
	$('#formAjax').submit(function() {
		...
		$.ajax({
			...
			success: function(res) {
				if (res.status == true) {
					bx_alert_successUpadate(res.message, 'administrator/ksb-keuangan');
				}else {
