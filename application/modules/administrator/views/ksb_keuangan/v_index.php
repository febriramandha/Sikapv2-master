...
<div class="card">
	<div class="card-header bg-white header-elements-inline py-2">
		<h5 class="card-title">Data Kasubag Keuangan</h5>
	...
	<div class="card-body">
		<div class="form-group row">
			<div class="text-left col-lg-12">
				<a href="<?php echo base_url('administrator/ksb-keuangan/add') ?>" class="btn btn-sm btn-info"><i
...
<script type="text/javascript">
	$(document).ready(function() {
		table = $('#datatable').DataTable({
			...
			ajax: {
				url: uri_dasar + 'administrator/ksb-keuangan/indexJson',
				type: "post",
				"data": function(data) {
	...
	function confirmAksi(id) {
		$.ajax({
			type: 'get',
			url: uri_dasar + 'administrator/ksb-keuangan/AjaxDel',
			data: {
				id: id
			},
			dataType: "JSON",
	...
	$('#cetak').click(function() {
		newWindow = window.open(uri_dasar + 'administrator/ksb-keuangan/cetak/' + $('[name="instansi"]').val(),
