    ...
    <div class="card-body">
        <div class="form-group row">
            <div class="text-left col-lg-12">
                <a href="<?php echo base_url('administrator/ksb-kepegawaian/add') ?>" class="btn btn-sm btn-info"><i
...
$('#cetak').click(function() {
    newWindow = window.open(uri_dasar + 'administrator/ksb-kepegawaian/cetak/' + $('[name="instansi"]').val(),
