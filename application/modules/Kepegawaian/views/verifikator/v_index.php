...
$(document).ready(function(){
     table = $('#datatable').DataTable({ 
	    ...
	    ajax: {
	        url : uri_dasar+'kepegawaian/verifikator/indexJson',
	        type:"post",
	        "data": function ( data ) {	
	    ...
	    "columns": [
	        ...
	        {"data": "verifikator", searchable:false},
	    ],
...
$('#cetak').click(function() {
	  newWindow = window.open(uri_dasar + 'kepegawaian/verifikator/cetak/'+$('[name="instansi"]').val(),"open",'height=600,width=800');
