	...
	public function AjaxGet()
	{
		...
		if ($this->mod == "DataPegawai") {
			$dept_id = decrypt_url($this->input->get('id'),'instansi');
				...
				$this->data['pegawai_lkh'] = $this->m_absen->PegawaiAbsenQueryRekapitulasiLkhDetail($user_id_in, $rank1, $rank2,$dept_id )->result();
				$this->load->view('grafik_lkh/v_grafik', $this->data);
		}
