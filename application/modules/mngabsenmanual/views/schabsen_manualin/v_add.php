    ...
    <div class="form-group row">
     ...
     <div class="col-lg-2">
      <label class="pure-material-checkbox"> 
        <input type="checkbox"  name="cekin"  /> <span>Masuk Kerja</span>
      </label>
    </div>
    <div class="col-lg-2">
      <label class="pure-material-checkbox"> 
        <input type="checkbox" name="cekout" /> <span>Pulang Kerja</span>
      </label>
    </div>
  </div>   
   <div class="form-group row">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
   table = $('#datatable').DataTable({ 
    ...
    ajax: {
      url : uri_dasar+'mngabsenmanual/schabsen-manualin/PegawaiJson',
      type:"post",
      "data": function ( data ) { 
  ...
  $('#formAjax').submit(function() {
    ...
    success: function(res) {
      if (res.status == true) {
        bx_alert_success(res.message, 'mngabsenmanual/schabsen-manualin');
      }else {
