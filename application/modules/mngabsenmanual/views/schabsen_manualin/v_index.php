...
<div class="card">
	<div class="card-header bg-white header-elements-inline py-2">
		<h5 class="card-title">Jadwal Absen Manual Instansi</h5>
...
<script type="text/javascript">
	$(document).ready(function(){
		table = $('#datatable').DataTable({ 
			...
			ajax: {
				url : uri_dasar+'mngabsenmanual/schabsen-manualin/indexJson',
				type:"post",
				"data": function ( data ) { 
   ...
   loadSettings();
	...
	function confirmAksi(id) {
		$.ajax({
			url: uri_dasar+'mngabsenmanual/schabsen-manualin/AjaxDel',
			data: {id: id},
			dataType :"json",
			error:function(){
