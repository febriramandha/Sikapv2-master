...
<div class="card">
	<div class="card-header bg-white header-elements-inline py-2">
		<h5 class="card-title">Jadwal Piket Manual</h5>
	...
	<div class="card-body">
		<div class="text-left mb-2" >                 
			<a href="<?php echo base_url('mngabsenmanual/schpiket-manual/add') ?>" class="btn btn-sm btn-info"><i class="icon-pen-plus mr-1"></i> Tambah Jadwal</a>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		table = $('#datatable').DataTable({ 
			...
			ajax: {
				url : uri_dasar+'mngabsenmanual/schpiket-manual/indexJson',
				type:"post",
				"data": function ( data ) { 
   ...
   loadSettings();
	...
	function confirmAksi(id) {
		$.ajax({
			url: uri_dasar+'mngabsenmanual/schpiket-manual/AjaxDel',
			data: {id: id},
			dataType :"json",
			error:function(){
