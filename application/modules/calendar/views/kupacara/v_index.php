...
<div class="card">
	<div class="card-header bg-white header-elements-inline py-2">
		<h5 class="card-title">Kalender Upacara</h5>
...
<div id="modalkalender" class="modal fade" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open('calendar/kupacara/AjaxSave','id="formAjax"'); ?>
      <input type="hidden" name="id">
      <input type="hidden" id="start" name="start">
      <input type="hidden" id="end" name="end">
      <div class="modal-body">
           <div class="form-group row">
              <label class="col-form-label col-lg-3">Tanggal Upacara <span class="text-danger">*</span></label>
              <div class="col-lg-9">
                  <div class="form-group-feedback form-group-feedback-left">
                      <div class="form-control-feedback">
                        <i class="icon-pencil3"></i>
                      </div>
                      <input type="text" name="tanggal" class="form-control" placeholder="isi tanggal upacara" disabled="">
                  </div>
              </div>
          </div>
          <div class="form-group row">
              <label class="col-form-label col-lg-3">Jam Upacara <span class="text-danger">*</span></label>
              <div class="col-lg-4">
                  <div class="form-group-feedback form-group-feedback-left">
                      <div class="form-control-feedback">
                        <i class="icon-pencil3"></i>
                      </div>
                      <input type="text" name="jam" class="form-control clockpicker" placeholder="isi jam upcara" >
                  </div>
              </div>
          </div>
...
$('.clockpicker').clockpicker({
  ...
  $(function(){
    ...
    $('#fullcalendar-external').fullCalendar({
        ...
        events: uri_dasar+'calendar/kupacara/getEvents',
        selectable: true,
        selectHelper: true,
        ...
        select: function(start, end) {
                ...
                $('input[name="tanggal"]').val(moment(start).format('DD-MM-YYYY'));
    ...
    function modal(data,aksi) {
        ...
        $('[name="jam"]').val(data ? data.jam : '');
        // Create Butttons
        if (data) {
            $('.modal-title').html('Edit Kalender');
            $('input[name="tanggal"]').val(moment(currentEvent.start).format('DD-MM-YYYY'));
...
$(document).ready(function(){
     table = $('#datatable').DataTable({ 
	    ...
	    ajax: {
	        url : uri_dasar+'calendar/kupacara/indexJson',
	        type:"post",
	        "data": function ( data ) {	
...
function confirmAksi(id) {
        $.ajax({
            url: uri_dasar+'calendar/kupacara/ajaxDel',
            data: {id: id},
            dataType :"json",
            error:function(){
	           bx_alert('gagal menghubungkan ke server cobalah mengulang halaman ini kembali');
