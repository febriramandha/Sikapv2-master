...
<div class="card">
	<div class="card-header bg-white header-elements-inline py-2">
		<h5 class="card-title">Jadwal LKH</h5>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = $('#datatable').DataTable({ 
			...
			ajax: {
				url : uri_dasar+'mnglkh/schlkh/indexJson',
				type:"post",
				"data": function ( data ) {	
			...
			{"data": "count_inday", searchable:false},
			{"data": "count_verday", searchable:false},
			...
			createdRow: function(row, data, index) {
				...
				$('td', row).eq(6).addClass('text-nowrap text-center');
			},
