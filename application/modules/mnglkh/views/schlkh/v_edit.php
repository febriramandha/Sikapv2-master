      ...
      <div class="form-group row">
        ...
        <div class="col-lg-9">
          <div class="form-group-feedback form-group-feedback-left">
            ...
            <input type="text" name="nama" class="form-control" placeholder="Nama Jadwal" value="<?php echo $sch_lkh->name ?>">
          </div>
        </div>
      </div>
      <div class="form-group row">
          ...
          <div class="form-group">
           <select class="form-control multiselect-clickable-groups" name="instansi[]" multiple="multiple" id="filter_list_dropdwn" data-fouc>
             <?php foreach ($instansi as $row) { 
               $instansi_cek =  pg_to_array($sch_lkh->dept_id);
               $selected ='';
    ...
    <div class="form-group row">
      ...
      <div class="col-lg-4">
        <div class="form-group-feedback form-group-feedback-left">
          ...
          <input type="text" name="rank1" class="form-control datepicker" placeholder="tanggal mulai" value="<?php echo format_tgl_ind($sch_lkh->start_date) ?>">
        </div>
      </div>
      <div class="col-lg-1">
        <div class="form-group">
      ...
      <div class="col-lg-4">
        <div class="form-group-feedback form-group-feedback-left">
          ...
          <input type="text" name="rank2" class="form-control datepicker" placeholder="tanggal berakhir" value="<?php echo format_tgl_ind($sch_lkh->end_date) ?>">
        </div>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-lg-4">
        <div class="form-group-feedback form-group-feedback-left">
          ...
          <input type="text" name="lkh_in" class="form-control" placeholder="waktu hari LKH input" value="<?php echo $sch_lkh->count_inday ?>">
        </div>
      </div>
      <div class="col-lg-1">
        <div class="form-group">
      ...
      <div class="col-lg-4">
        <div class="form-group-feedback form-group-feedback-left">
          ...
          <input type="text" name="lkh_ver" class="form-control" placeholder="waktu hari LKH verifikasi" value="<?php echo $sch_lkh->count_verday ?>">
        </div>
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-lg-9">
       <textarea id="ckeditor" name="isi"><?php echo $sch_lkh->ket ?></textarea>
     </div>
   </div>
   <input type="hidden" name="id" value="<?php echo $sch_lkh->id ?>">
...
<script type="text/javascript">
  ...
  $('#formAjax').submit(function() {
    ...
    success: function(res) {
      if (res.status == true) {
        bx_alert_successUpadate(res.message, 'mnglkh/schlkh');
      }else {
