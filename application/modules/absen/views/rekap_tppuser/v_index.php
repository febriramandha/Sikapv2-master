...
<div class="card">
    ...
    <?php echo form_open('absen/rekap-tppuser/cetak','class="form-horizontal" target="popup" id="formAjax"'); ?>
    <div class="card-body">
...
$(document).ready(function() {
    table = $('#datatable').DataTable({
        ...
        ajax: {
            url: uri_dasar + 'absen/rekap-tppuser/indexJson',
            type: "post",
            "data": function(data) {
...
function DataPegawai() {
    ...
    $.ajax({
        type: 'get',
        url: uri_dasar + 'absen/rekap-tppuser/AjaxGet',
        data: {
            mod: 'DataPegawai',
            id: dept_id,
            pns: pns,
