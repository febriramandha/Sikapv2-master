...
<div class="card">
	<div class="card-header bg-white header-elements-inline py-2">
		<h5 class="card-title">Data Kehadiran Wirid</h5>
	...
	<div class="card-body">
		<?php echo form_open('absen/data-wirid/cetak','class="form-horizontal" target="popup" id="formAjax"'); ?>
		...
		<div class="text-left offset-lg-2" >
			<span type="submit" class="btn btn-sm btn-info result" id="kalkulasi">Tampilkan <i class="icon-search4 ml-2"></i></span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = $('#datatable').DataTable({
			...
			ajax: {
				url : uri_dasar+'absen/data-wirid/indexJson',
				type:"post",
				"data": function ( data ) {
