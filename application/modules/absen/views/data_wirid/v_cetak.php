...
foreach ($data_wirid as $row) {
	...
	$html .='<tr nobr="true">
                        ...
                        <td>'.$row->ket.'</td> 
                        <td>'.tglInd_hrtabel($row->tgl_apel).'('.jm($row->start_time).')</td> 
...
<div class="d-lg-none">
	<a class="btn btn-sm btn-info m-2" href="data:application/pdf;base64,<?php echo $pdfBase64 ?>" download="FileLaporan_DataAbsenWirid__<?php echo $user->nip ?>.pdf">Download</a>
</div>
