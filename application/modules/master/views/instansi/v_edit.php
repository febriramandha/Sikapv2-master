...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="col-lg-12">
                ...
                <div class="col-lg-10">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" class="form-control" name="nama" placeholder="Isi nama instansi disini"
                            value="<?php echo $instansi->dept_name ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" class="form-control" name="alias" placeholder="Isi nama singkat disini"
                            value="<?php echo $instansi->dept_alias ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="form-group">
                        <select class="form-control select-search" name="kategori">
                            ...
                            <option value="nonunit" <?php if($instansi->dept_type == "nonunit") { echo "selected";} ?>>
                                Non Unit Kerja</option>
                            <option value="opd" <?php if($instansi->dept_type == "opd") { echo "selected";} ?>>OPD
                            </option>
                            <option value="subopd" <?php if($instansi->dept_type == "subopd") { echo "selected";} ?>>Sub
                                OPD</option>
                            <option value="puskesmas"
                                <?php if($instansi->dept_type == "puskesmas") { echo "selected";} ?>>Puskesmas</option>
                            <option value="sekolah" <?php if($instansi->dept_type == "sekolah") { echo "selected";} ?>>
                                Sekolah</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group row">
                <label class="col-form-label col-lg-2">Simpeg Unit Kerja <span class="text-danger">*</span></label>
                <div class="col-lg-10">
                    <div class="form-group">
                        <?php 
            ...
            <div class="form-group row">
                <label class="col-form-label col-lg-2">Parent Unit Kerja <span class="text-danger">*</span></label>
                <div class="col-lg-10">
                    <div class="form-group">
                        <?php 
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-2">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="number" class="form-control" name="order" placeholder="nomor urut"
                            value="<?php echo $instansi->position_order ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                        ...
                        <span class="input-group-prepend">
                            <span class="input-group-text">
                                <input type="checkbox" name="status" class="form-control-switchery"
                                    <?php if ($instansi->status == 1) { echo "checked";} ?> data-fouc>
                            </span>
                        </span>
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="input-group">
                        <span class="input-group-prepend">
                            <span class="input-group-text">
                                <input type="checkbox" name="absen_online" class="form-control-switchery"
                                    <?php if ($instansi->absen_online == 1) { echo "checked";} ?> data-fouc>
                            </span>
                        </span>
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" class="form-control" name="alamat" value="<?php echo $instansi->alamat ?>"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" class="form-control" name="latlong" value="<?php echo $instansi->latlong ?>"
                            placeholder="Isi Titik Koordinat Kantor">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="number" class="form-control" name="radius" placeholder="Isi Radius"
                            value="<?php echo $instansi->radius ?>">
                    </div>
                </div>
            </div>
