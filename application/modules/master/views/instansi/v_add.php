    ...
    <div class="card-body">
        ...
        <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" class="form-control" value="<?php echo $instansi_induk->dept_name ?>"
                            disabled="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <div class="form-group">
                        <select class="form-control select-search" name="kecamatan">
                            ...
                            <option value="<?php echo encrypt_url($row->id,'kecamatan_id') ?>"><?php echo $row->nama ?>
                            </option>
                            <?php } ?>
                        </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="form-group">
                        <select class="form-control select-search" name="simpeg_dept_id">
                            <option disabled="">Pilih Unit Kerja</option>
                            <?php foreach ($instansi_simpeg as $row) { ?>
                            <option value="<?php echo encrypt_url($row->id,'simpeg_dept_id') ?>">
                                <?php echo strtoupper($row->nama_unor) ?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <div class="input-group">
                        <span class="input-group-prepend">
                            <span class="input-group-text">
                                <input type="checkbox" name="absen_online" class="form-control-switchery" checked
                                    data-fouc>
                            </span>
                        </span>
                    </div>
