...
<div class="card">
    <div class="card-header bg-white header-elements-inline py-2">
        <h5 class="card-title">Data Kelas Jabatan</h5>
    ...
    <div class="card-body">
        <div class="text-left">
            <a href="<?php echo base_url('master/class_position/add') ?>" class="btn btn-sm btn-info"><i
...
$(document).ready(function() {
    table = $('#datatable').DataTable({
        ...
        ajax: {
            url: "<?php echo site_url('master/class_position/AjaxGet') ?>",
            type: "post",
            "data": function(data) {
