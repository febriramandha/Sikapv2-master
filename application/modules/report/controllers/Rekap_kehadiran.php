...
class Rekap_kehadiran extends App_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->_init();
		$this->breadcrumbs->push('Rekapitulasi Kehadiran', 'report/rekap-kehadiran');
	...
	public function index()
	{
		...
		$this->load->view('rekap_kehadiran/v_index', $this->data);
	}
