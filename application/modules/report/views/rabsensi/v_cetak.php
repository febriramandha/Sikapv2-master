<?php
    ...
    $ttd ='<div align="center">
            <table width="100%">
                <tr nobr="true">
                    <td width="70%" align="left"><b>Ket :</b>  <br><br>- H : Hadir Normal - TM : Telat Masuk - PC : Pulang Cepat - TC : Telat Masuk Pulang Cepat - C* : Cuti - DL : Dinas Luar A : Apel TOL : Apel Tidak Menggunakan Absen Online
                    <br>- *M : * Manual
