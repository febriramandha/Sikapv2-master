...
<div class="card">
    ...
    <div class="card-body">
        <div style="display: flex;flex-direction: row-reverse;">
            <a href="<?php echo base_url('kepegawaian/tpp_pegawai/add') ?>" class="btn btn-sm btn-info"><i class="icon-pen-plus mr-1"></i>Tambah Baru</a>
        </div>
...
$(document).ready(function() {
    table = $('#datatable').DataTable({
        ...
        ajax: {
            url: uri_dasar + 'kepegawaian/tpp_pegawai/AjaxGet',
            type: "post",
            "data": function(data) {
        ...
        createdRow: function(row, data, index) {
            ...
            $('td', row).eq(17).addClass('text-nowrap p-1 text-center');
            $('td', row).eq(18).addClass('text-nowrap p-1 text-center');
            // $('td', row).eq(19).addClass('text-nowrap p-1 text-center');
...
$('#cetak').click(function() {
    ...
    if (idbulan) {
        newWindow = window.open(uri_dasar + 'kepegawaian/tpp_pegawai/cetak/' + idbulan, "open",
...
function confirmAksi(id) {
        $.ajax({
            url: "<?php echo site_url('kepegawaian/tpp_pegawai/AjaxDel') ?>",
            data: {id: id},
            dataType :"json",
