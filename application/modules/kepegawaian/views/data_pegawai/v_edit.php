            ...
            <div class="col-lg-4">
             ...
             <div class="col-lg-3">
              <div class="form-group-feedback form-group-feedback-left">
                ...
                <input type="text" name="gelar_dpn" class="form-control" placeholder="gelar depan" value="<?php echo $user->gelar_dpn ?>">
              </div>
            </div>
            <div class="col-lg-3">
              <div class="form-group-feedback form-group-feedback-left">
                ...
                <input type="text" name="gelar_blk" class="form-control" placeholder="gelar belakang" value="<?php echo $user->gelar_blk ?>">
              </div>
            </div>
        </div>
        ...
        <div class="form-group row" id="nip">
          ...
          <div class="col-lg-10">
            <div class="form-group-feedback form-group-feedback-left">
              ...
              <input type="text" name="jabatan" class="form-control" placeholder="jabatan"  value="<?php echo $user->jabatan ?>">
               <span class="text-danger" ><i>* data jabatan diperbarui dari aplikasi SIMPEG (beri tanda (-) jika tidak ada) </i></span>
            </div>
          </div>
        </div>
        <div class="form-group row nip_pegawai">
              ...
              <div class="form-group">
               <select class="form-control select-nosearch" name="status_pegawai" disabled>  
                ...
                <?php foreach ($status_peg as $row) {?>    
                    <option value="<?php echo $row->id ?>" <?php if ($row->id == $user->statpeg_id) { echo "selected";} ?>><?php echo $row->nama ?></option>
                <?php } ?>
              </select> 
            </div>
          </div>
                ...
                <div class="form-group">
                     <select class="form-control select-nosearch" name="agama">  
                            <?php foreach ($agama as $row) {?>    
                              <option value="<?php echo $row->id ?>" <?php if ($user->agama_id == $row->id) { echo "selected";} ?>><?php echo $row->agama ?></option>
                          <?php } ?>
                    </select> 
                </div>
            </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-lg-10">
      <div class="input-group">
        <span class="input-group-prepend">
          <span class="input-group-text">
            <input type="checkbox" name="status_att" class="form-control-switchery" <?php if ($user->att_status == 1) { echo "checked";} ?> data-fouc disabled="true">
          </span>
        </span>
      </div>
