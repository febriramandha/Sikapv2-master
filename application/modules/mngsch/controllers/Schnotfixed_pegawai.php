...
class Schnotfixed_pegawai extends App_Controller {
	...
	public function PegawaiJson()
	{
		...
		$this->load->library('datatables');
        $this->datatables->select('a.id, a.nip, a.nama,a.dept_id, a.dept_name, status_pegawai,gelar_dpn,gelar_blk, b.user_id as checked, usercek.user_id as disabled, d.tgl_pindah')
        	->from('v_users_all a')
