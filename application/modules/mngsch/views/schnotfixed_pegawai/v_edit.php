...
<div class="card">
  <div class="card-header bg-white header-elements-inline py-2">
    <h5 class="card-title">Jadwal Tidak Tetap Pegawai</h5>
  ...
  <?php echo form_open('mngsch/schnotfixed-pegawai/AjaxSave','class="form-horizontal" id="formAjax"'); ?>
		<div class="col-lg-12">
          ...
          <input type="hidden" name="id" value="<?php echo encrypt_url($sch_run->row()->id,'schrun_id_notfixed') ?>">
...
$('#checkAll').click(function () {    
  ...
  $(document).ready(function(){
     table = $('#datatable').DataTable({ 
      ...
      ajax: {
          url : uri_dasar+'mngsch/schnotfixed-pegawai/PegawaiJson',
          type:"post",
          "data": function ( data ) { 
  ...
  var spinner = $('#spinner');
    $.ajax({
        ...
        success: function(res) {
            if (res.status == true) {
                 bx_alert_success(res.message, 'mngsch/schnotfixed-pegawai');
            }else {
