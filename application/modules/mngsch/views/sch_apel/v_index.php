...
<div class="card">
	...
	<div class="card-body">
      ...
      <span class="font-weight-semibold">info!</span> Klik tanggal untuk melakukan aksi
        ...
        <div class="text-left">
			<a href="<?php echo base_url('mngsch/sch-apel/add') ?>" class="btn btn-sm btn-info"><i class="icon-pen-plus mr-1"></i> Tambah Apel</a>
		</div>
		<div class="row">
				<div class="col-md-8">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="alert alert-warning alert-dismissible p-2">
		    <span class="font-weight-semibold">Perhatian!</span> Data yang telah diinputkan hanya dapat diubah pada H-1 ! 
		</div>	
          ...
          <div class="form-group row">
              ...
              <div class="col-lg-9">
                  <div class="form-group-feedback form-group-feedback-left">
                      ...
                      <input type="text" name="tgl_apel" class="form-control" placeholder="isi tanggal apel" disabled="">
                  </div>
              </div>
          </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" name="start_time" id="start_time" class="form-control clockpicker" placeholder="isi jam mulai apel" value="07:31">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" name="end_time" id="end_time" class="form-control clockpicker" placeholder="isi jam berakhir apel" >
                    </div>
                </div>
            </div>  
           <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <div class="form-group">
                        <select class="form-control select-search" name="jenis_apel_id" id="jenis_apel_id">  
                                ...
                                <option value="<?php echo encrypt_url($row->id,'jenis_apel'); ?>"><?php echo $row->name ?></option> 
                                <?php } ?>
                        </select> 
                    </div>
                </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-lg-9">
                  <div class="form-group-feedback form-group-feedback-left">
                      ...
                      <input type="text" name="pengambilan_apel" class="form-control" placeholder="Pengambilan Apel">
                  </div>
              </div>
          </div> 
          ...
          <div class="form-group row">
              ...
              <div class="col-lg-9">
                  <div class="form-group">
                       <select class="form-control multiselect-clickable-groups instansi" name="instansi[]" id="instansi" multiple="multiple" id="filter_list_dropdwn" data-fouc>
...
$(document).ready(function(){
     table = $('#datatable').DataTable({ 
	    ...
	    "columns": [
	        ...
	        {"data": "tgl_apel", searchable:false},
	        {"data": "name", searchable:false},
	        {"data": "komandan_apel", searchable:false},
	        {"data": "pengambilan_apel", searchable:false},
	    ],
