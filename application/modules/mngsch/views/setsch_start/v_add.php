...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="col-lg-12">
            ...
            <div class="form-group row">
                <label class="col-form-label col-lg-2">Centang Pegawai <span class="text-danger">*</span></label>
                <div class="col-lg-10">
                    <div class="input-group">
                        <span class="input-group-prepend">
                            <span class="input-group-text">
                                <input type="checkbox" name="centang_pegawai" class="form-control-switchery" data-fouc>
                            </span>
                        </span>
                    </div>
                </div>
                        ...
                        <table class="table table-sm table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="py-1">
                                        <select class="form-control select-search select_hari"
                                            name="h<?php echo $row_day->id ?>">
                                            <option disabled="">Pilih Jam Kerja</option>
                                            <?php foreach ($sch_class as $row) { ?>
                                            <option value="<?php echo $row->id ?>"><?php echo $row->name ?>
                                                (<?php echo $row->start_time ?> - <?php echo $row->end_time ?>)</option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                </tr>
