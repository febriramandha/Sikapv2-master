...
<div class="card">
  ...
  ?>
    <div class="card-body">
        <!-- <div class="alert alert-danger alert-dismissible mb-0 p-2">
      ...
      <br> -->
        ...
        <div class="col-lg-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-2">
                    <div class="form-group-feedback form-group-feedback-left">
                        ...
                        <input type="text" name="jam2" class="form-control clockpicker readonlyjm"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-5">
                    ...
                    if(!empty($cek_persentase_kemarin)){ ?>
                            <option value="<?php echo encrypt_url($v,"tanggal_lkh_add_$date_now") ?>"
                                data-icon="calendar3"><?php echo tgl_ind_hari($v) ?></option>
                            <?php }else{ ?>
                            <option value="<?php echo encrypt_url($v,"tanggal_lkh_add_$date_now") ?>"
                                data-icon="calendar3" <?php if($tanggal_lkh[1] === $v) {echo "selected='yes'"; }?>>
                                <?php echo tgl_ind_hari($v) ?></option>
                            <?php } 
                 } ?>
                        </select>
                        ...
                        <div class="alert alert-warning border-0 alert-dismissible mb-0">
                            <span class="font-weight-semibold">Peringatan!</span> Jadwal anda belum tersedia mohon
                            hubungi administrator tentang jadwal anda.
                        </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="text-left offset-lg-2">
                <a href="<?php echo base_url('datalkh/lkh') ?>" class="btn btn-sm bg-warning legitRipple"><i
                        class="icon-undo2"></i> Kembali</a>
