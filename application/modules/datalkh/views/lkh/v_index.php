...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-warning alert-dismissible p-2">
            <span class="font-weight-semibold">Perhatian!</span> untuk penambahan dan perubahan data hanya dapat
            dilakukan pada tanggal:
            <?php foreach ($tanggal_lkh as $v ){
        ...
        <div class="text-left mb-2">
            <a href="<?php echo base_url('datalkh/lkh/add') ?>" class="btn btn-sm btn-info"><i
            ...
            <table id="datatable" class="table table-sm table-hover table-bordered">
                <thead>
                    <tr class="table-active">
                        ...
                        <th class="text-nowrap text-center p-1" width="1%">Jam
                            <hr class="m-0">(mulai - selesai)
                        </th>
...
$('#cetak').click(function() {
    ...
    if (rank1 && rank2) {
        newWindow = window.open(uri_dasar + 'datalkh/lkh/cetak/' + rank1 + '/' + rank2, "open",
