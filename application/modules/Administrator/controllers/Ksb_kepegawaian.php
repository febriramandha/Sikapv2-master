...
class Ksb_kepegawaian extends App_Controller {
	...
	public function __construct()
	{
		parent::__construct();
		$this->_init();
		$this->breadcrumbs->push('Kasubag Kegawaian', 'administrator/ksb-kepegawaian');
		$this->data['title'] = "Kasubag Kegawaian";
	...
	{
		$this->data['sub_title']  = "Kasubag Kegawaian";
		$this->data['breadcrumb'] = $this->breadcrumbs->show();
		$this->data['instansi']	  = $this->m_instansi->GetInstasiDeptID($this->session->userdata('tpp_dept_id'))->result();
		$this->load->view('ksb_kepegawaian/v_index', $this->data);
	}
	...
	public function add()
	{
		$this->data['sub_title'] 	= "Tambah Data Kasubag Kegawaian";
		$this->breadcrumbs->push('Tambah Kasubag Kegawaian', '/');
		$this->data['breadcrumb'] 	= $this->breadcrumbs->show();
		$this->data['instansi']		= $this->m_instansi->GetInstasiDeptID($this->session->userdata('tpp_dept_id'))->result();
		$this->load->view('ksb_kepegawaian/v_add', $this->data);
	}

	public function edit($id)
	{
		$this->data['sub_title'] 	= "Edit Data Kasubag Kegawaian";
		$this->breadcrumbs->push('Edit Kasubag Kegawaian', '/');
		$this->data['breadcrumb'] 	= $this->breadcrumbs->show();
		$this->data['user']			= $this->m_user->GetUserPejabat(decrypt_url($id, 'pejabatinstansi_id'), 7)->row();
		$this->data['instansi']		= $this->m_instansi->GetInstasiDeptID($this->session->userdata('tpp_dept_id'))->result();
		$this->load->view('ksb_kepegawaian/v_edit', $this->data);
	}
	...
	public function cetak($dept_id)
	{
		...
		$this->data['user']		= $this->m_user->GetUserAllPejabat(decrypt_url($dept_id, 'instansi'), 7)->result();
		$this->load->view('ksb_kepegawaian/v_cetak', $this->data);
	}

}

/* End of file Ksb_kepegawaian.php */
