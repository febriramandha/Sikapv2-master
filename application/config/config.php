...
// $config['allowed_array'] = array('192.168.2.2', '192.176.3.11');
...
if (isset($_SERVER['HTTPS'])  == "on") {
	$config['base_url'] .= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME'])."/v2";
}else {
...
|
*/
$config['encryption_key'] = 'sikap.agamkab.go.id/rianreski/akses/1';
...
$config['sess_cookie_name'] = 'sikap_session';
...
$config['csrf_token_name'] = 'csrf_sikap_token_name';
